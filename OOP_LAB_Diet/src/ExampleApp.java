...
public class ExampleApp {
    ...
    public static void main(String[] args)  {
        ...
        food.defineRawMaterial("Samandan", 530, 6.8, 56, 31);
        ...
        Recipe recipe = food.createRecipe("Samandan and Dilshod");
         recipe.addIngredient("Samandar",70);
         recipe.addIngredient("Dilshod",30);
